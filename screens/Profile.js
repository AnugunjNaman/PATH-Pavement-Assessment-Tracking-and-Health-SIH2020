...
const Profile = (props) => {
    ...
    return(
        ...
        >
            ...
            <Card style={styles.myCard}>
                <View style={styles.cardContent}>
                    <Text style={styles.myText}>Number of Images: {imageUrls.length}</Text>
                </View>
            </Card>
            ...
            <Card style={styles.myCard} onPress={()=>{
                ...
                props.navigation.navigate("ViewImage", {damageImageUrls})
                }}>
                <View style={styles.cardContent} >
            ...
            <View style={{flexDirection: 'row', justifyContent:'space-evenly', padding:10}}>
                <Button theme={theme} style={styles.inputStyle } mode="contained" 
                onPress={() => {
                ...
                <Button theme={theme} style={styles.inputStyle } mode="contained" onPress={() => deleteRoad()}>
                    Delete
                </Button>
            </View>
        </View>
